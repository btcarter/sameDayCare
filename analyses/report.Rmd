...
df.flat %>% 
  ggplot(
    aes(distance_travelled, days_to_return, color=return_in_14)
  ) +
...
## Potential enriching data
- Basic vital signs, medications, preexisting conditions.
...
- What do we do with false negatives?

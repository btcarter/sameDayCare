...
# Filtered
- SDC encounters with a return to Roundup Memorial Clinic were removed because we can't query the data for return information. This removed aproximately 33,000 encounters at SDC/EC facilities from the dataset.

# Revisions
- Added investigation into 'Frequent Fliers' and returns only to Billings Clinic Hospital.

...
print(paste("Features correlated with ", params$respVar, sep=""))
...
# xgb.plot.tree(model = xg.model, trees = 0)
xgb.ggplot.deepness(model = xg.model)
xgb.plot.multi.trees(model = xg.model)
```

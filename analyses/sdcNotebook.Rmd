...
df.path <- file.path(data.dir.path, "All.2016-2019.2020-05-07.csv")
...
df.processed <- df %>%
  ...
  mutate(
    ...
    MaritalStatusDSC = na_if(EthnicityDSC, " "),
...
```{r summStats}
DESC <- compareGroups::compareGroups(~AdmitDayOfWeek + GenderDSC + RaceDSC + EthnicityDSC + MaritalStatusDSC, df.sdc, max.xlev = 22)

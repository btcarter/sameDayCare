...
female <- update(tab, x = update(DESC, . ~ . - GenderDSC, subset = GenderDSC == "FEMALE"), show.n = FALSE)
male <- update(tab, x = update(DESC, . ~ . - GenderDSC, subset = GenderDSC == "MALE"))

test <- cbind("Females" = female, "Males" = male)
print(male)
```

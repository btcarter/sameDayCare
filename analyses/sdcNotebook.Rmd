...
df.path <- file.path(data.dir.path, "All.2016-2019.2020-06-10.csv")
...
linearModel <- glm(
  return_in_14 ~ AdmitAgeNBR + GenderDSC + RaceDSC + MaritalStatusDSC + ICD9.priority + Dept,
...
lmer.model <-  lmer(return_str ~ 
      AdmitAgeNBR + GenderDSC + RaceDSC + EthnicityDSC + MaritalStatusDSC + 
      (1|PersonID) + AppointmentLocationCVDisplayCVDSC + ICD9.priority + Dept + HeartFailure,
      df.sdc.flattened
    )

...
df.sdc.flattened$return_in_14 <-
  for (person in df.sdc.flattened$PersonID){
    df.sdc.flattened %>% 
      select(
        PersonID == person
      ) %>% 
